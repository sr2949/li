...
public class PlayerAttack : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //{
        //    canDamage = false;
        //    other.transform.gameObject.GetComponent<EnemyMove>().enemyHealth -=
        //   damageAmt + SaveScript.weaponIncrease +
        //   SaveScript.strengthIncrease;
        ...
        //    canDamage = false;
        //    other.transform.gameObject.GetComponent<EnemyMove>().enemyHealth -=
        //   (damageAmt / 8) + SaveScript.weaponIncrease +
        //   SaveScript.strengthIncrease;
        //    StartCoroutine(ResetDamage());
        //}
        ...
        //{
        //    canDamage = false;
        //    other.transform.gameObject.GetComponent<DragonScript>().enemyHealth
        //   -= (damageAmt / 8) + SaveScript.weaponIncrease +
        //   SaveScript.strengthIncrease;
        //    StartCoroutine(ResetDamage());
        //}
